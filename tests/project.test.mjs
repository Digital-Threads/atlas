...
test("covers the complete NestJS MVP architecture surface", async () => {
  ...
  assert.match(viewerApp, /compactSemanticLabel/);
  assert.match(viewerApp, /text-overflow-wrap/);
  ...
  assert.match(viewerApp, /expandedSemanticOperationId/);
  assert.match(viewerApp, /setViewKindToggle/);
  assert.match(viewerApp, /renderRiskScene/);
  assert.match(viewerApp, /highlightSourceLine/);
  ...
  assert.match(viewerCss, /\.inspector-actions/);
  assert.match(viewerCss, /\.metadata-disclosure/);
  assert.match(viewerCss, /\.source-line/);
  assert.match(viewerCss, /\.syntax-keyword/);
  ...
  assert.match(viewerHtml, /id="view-kind-toggle"/);
